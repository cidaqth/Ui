...
function Library:CreateWindow(title, gameName)
    ...
    openBT.Image = "rbxassetid://13560251864"
    ...
    mainLogo.Image = "rbxassetid://13560251864"
                    ...
                    sliderBtn.MouseButton1Down:Connect(function()
                        if not focusing then
                            ...
                            moveconnection = mouse.Move:Connect(function()
                                ...
                                Utility:TweenObject(liderDrag, {Size = UDim2.new(0, math.clamp(mouse.X - sliderDrag.AbsolutePosition.X, 0, 380), 0, 6)}, 0.05)
                                Utility:TweenObject(Circle, {Position = UDim2.new(0, math.clamp(mouse.X - sliderDrag.AbsolutePosition.X - 2, 0, 380), 0, -1)}, 0.05)
